...
export const updateFlightRoute =  (id, updatedFlightRoute) => axios.patch(`${flightRouteUrl}/${id}`, updatedFlightRoute);
...
export const updateschedule =  (id, updatedSchedule) => axios.patch(`${scheduleRouteUrl}/${id}`, updatedSchedule);
